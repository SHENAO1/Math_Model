...
x09=y9(1,1+t0/h);%%%%%%%%%对应于t0时刻的坐标
y09=y9(2,1+t0/h);
z09=y9(3,1+t0/h);
r09=norm(y9(:,1+t0/h));
thou09=norm(y9(1:2,1+t0/h));
...
x09=y9(1,2+t0/h);%%%%%%%%%对应于t时刻的坐标
y09=y9(2,2+t0/h);
z09=y9(3,2+t0/h);
r09=norm(y9(:,2+t0/h));
thou09=norm(y9(1:2,2+t0/h));
A=[x09/r09 -y09/thou09 -x09*z09/r09/thou09; y09/r09 x09/thou09 -y09*z09/r09/thou09;z09/r09 0 thou09/r09];
...
x09=y9(1,3+t0/h);%%%%%%%%%对应于t时刻的坐标
y09=y9(2,3+t0/h);
z09=y9(3,3+t0/h);
r09=norm(y9(:,3+t0/h));
thou09=norm(y9(1:2,3+t0/h));
A=[x09/r09 -y09/thou09 -x09*z09/r09/thou09; y09/r09 x09/thou09 -y09*z09/r09/thou09;z09/r09 0 thou09/r09];
...
%    F=fun_equ(x,tempy9,tempt,tempalfa,tempbeta);
    ...
    state_zero=[state_zero x(1:6)];
    state_ini=inijinsi(x,h);
end
...
figure;
subplot(3,1,1);plot(t0:t0+l-1,comvel(1,:));title('t(49-171)-x');
subplot(3,1,2);plot(t0:t0+l-1,comvel(2,:));title('t(49-171)-y');
subplot(3,1,3);plot(t0:t0+l-1,comvel(3,:));title('t(49-171)-z');
%-------------------------------------------------------------------------%
hh=1;
tmin=0;
tmax=170;
...
for t=50:170
    ...
    xigma5=xigma5+tempv(1)*t^5;
    xigma6=xigma6+tempv(1)*t^6;
%     tempk=kxyz(xx,yy,zz,t);
    xigma0k1=xigma0k1+tempk(1);
    xigma1k1=xigma1k1+tempk(1)*t;
    xigma2k1=xigma2k1+tempk(1)*t^2;
    xigma3k1=xigma3k1+tempk(1)*t^3;
    
end
    Ax=[xigma0 xigma1 xigma2 xigma3;xigma1 xigma2 xigma3 xigma4;xigma2 xigma3 xigma4 xigma5;xigma3 xigma4 xigma5 xigma6];
    bx=[xigma0k1 xigma1k1 xigma2k1 xigma3k1]';
    xcoff=inv(Ax)*bx;
    %----------------------y方向-------------%
...
for t=50:170
    ...
    xigma5=xigma5+tempv(2)*t^5;
    xigma6=xigma6+tempv(2)*t^6;
%     tempk=kxyz(xx,yy,zz,t);
    xigma0k2=xigma0k2+tempk(2);
    xigma1k2=xigma1k2+tempk(2)*t;
    xigma2k2=xigma2k2+tempk(2)*t^2;
    xigma3k2=xigma3k2+tempk(2)*t^3;
end
    Ay=[xigma0 xigma1 xigma2 xigma3;xigma1 xigma2 xigma3 xigma4;xigma2 xigma3 xigma4 xigma5;xigma3 xigma4 xigma5 xigma6];
    by=[xigma0k2 xigma1k2 xigma2k2 xigma3k2]';
    ycoff=inv(Ay)*by;
...
for t=50:170
 [tempv ,tempk]=kxyz(xx,yy,zz,t);
    ...
    xigma5=xigma5+tempv(3)*t^5;
    xigma6=xigma6+tempv(3)*t^6;
%     tempk=kxyz(xx,yy,zz,t);
    xigma0k3=xigma0k3+tempk(3);
    xigma1k3=xigma1k3+tempk(3)*t;
    xigma2k3=xigma2k3+tempk(3)*t^2;
    xigma3k3=xigma3k3+tempk(3)*t^3;
end
    Az=[xigma0 xigma1 xigma2 xigma3;xigma1 xigma2 xigma3 xigma4;xigma2 xigma3 xigma4 xigma5;xigma3 xigma4 xigma5 xigma6];
    bz=[xigma0k3 xigma1k3 xigma2k3 xigma3k3]';
    zcoff=inv(Az)*bz;

%--------------反解微分方程------------------------------------------%
y_ini=[compos(1,1) comvel(1,1) compos(2,1) comvel(2,1) compos(3,1) comvel(3,1)]';
y_res=zeros(6,171);
y_res(:,49)=y_ini;
...
for t=50:170
    ...
    k1=vdp24(t-1,y_res(:,t-1),xcoff,ycoff,zcoff);
    k2=vdp24(t-1+hh/2,y_res(:,t-1)+hh*k1/2,xcoff,ycoff,zcoff);
    k3=vdp24(t-1+hh/2,y_res(:,t-1)+hh*k2/2,xcoff,ycoff,zcoff);
    k4=vdp24(t-1+hh,y_res(:,t-1)+hh*k3,xcoff,ycoff,zcoff);
...
figure;
subplot(3,1,1);plot(50:170,y_res(1,50:170));title('RG-t(49-171)-x');
subplot(3,1,2);plot(50:170,y_res(3,50:170));title('RG-t(49-171)-y');
subplot(3,1,3);plot(50:170,y_res(5,50:170));title('RG-t(49-171)-z');
figure;
subplot(3,1,1);plot(50:170,y_res(2,50:170));title('RG-t(49-171)-x');
subplot(3,1,2);plot(50:170,y_res(4,50:170));title('RG-t(49-171)-y');
subplot(3,1,3);plot(50:170,y_res(6,50:170));title('RG-t(49-171)-z');
