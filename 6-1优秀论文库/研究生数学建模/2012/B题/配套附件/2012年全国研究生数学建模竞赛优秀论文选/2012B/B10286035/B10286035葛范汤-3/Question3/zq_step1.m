...
NUM = 600;
Xsat06 = zq_sat06(1:NUM,1); % 600*1
Xsat09 = zq_sat09(1:NUM,1);

Ysat06 = zq_sat06(1:NUM,2);
Ysat09 = zq_sat09(1:NUM,2);

Zsat06 = zq_sat06(1:NUM,3);
Zsat09 = zq_sat09(1:NUM,3);
...
ddPM=0;
for i=1:NUM
    T3cs06 = Trans3CS([Xsat06(i); Ysat06(i); Zsat06(i)]);
...
%     
    ...
    PM(i,1:3) = [xm ym zm];
    if i>1
        dPM(i,1:3) = (PM(i,1:3)-PM(i-1,1:3))/deltaT;
    end
    if i>2
        ddPM(i,1:3) = (dPM(i,1:3)-dPM(i-1,1:3))/deltaT;
    end
end
% % func 1
