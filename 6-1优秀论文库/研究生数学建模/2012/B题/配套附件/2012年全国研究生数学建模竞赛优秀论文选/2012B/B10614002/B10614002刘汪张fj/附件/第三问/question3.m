...
function  [xx,yy,zz,dx,dy,dz,Y4]=question3()
load opt_ln6.mat
...
subplot(2,3,2),plot(ts5,Y5(:,3)),axis([0 200 6.15*10^6 6.35*10^6]),title('y-t')
subplot(2,3,3),plot(ts5,Y5(:,5)),title('z-t')
subplot(2,3,4),plot(ts5,Y5(:,2)),title('Vx-t')
subplot(2,3,5),plot(ts5,Y5(:,4)),axis([0 200 650 1300]),title('Vy-t')
