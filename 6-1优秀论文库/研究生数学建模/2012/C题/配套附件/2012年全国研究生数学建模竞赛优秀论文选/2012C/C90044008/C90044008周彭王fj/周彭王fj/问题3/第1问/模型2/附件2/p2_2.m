...
Fxielv=F3;
 for i=1:71
   weiyinew(i)=abs(u3(i+71)-u3(71))+u3(71);
 end
 for i=1:72
 weiyinew1(i)=u(i);
 end
  weiyinew3=[weiyinew1,weiyinew];
Fxielv2=Fxielv;
Fxielv3=[Fxielv,Fxielv(1)];
Fxielv3(1)=[];
...
print('-djpeg','-r600','泵功图')          % 以600 dpi的分辨率输出一个JPG 图片
print('-dtiff','-r300','泵功图')  % 以300 dpi的分辨率输出一个tiff 的 图片
saveas(gcf,'泵功图.fig')% 输出fig