...
%%
%-------[2]归一化泵功图的区间转移-------
F_S_Ori(1,1:2)=Rs(142:143);
F_S_Ori(1,3:78)=Rs(1:76);
F_S_Ori(2,1:2)=Rf(142:143);
F_S_Ori(2,3:78)=Rf(1:76);
for iN=79:143
    F_S_Ori(1,iN)=2-Rs(iN-(143-142+1));
    F_S_Ori(2,iN)=Rf(iN-(143-142+1));  
end
figure(2)
...
Area_idea=(0.98-0.312)*(0.9963-0.00754)
Area_ratio=Area/Area_idea
