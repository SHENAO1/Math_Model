...
fr1=pi*(DL1/2)^2;   %一级杆横截面积
fr2=pi*(DL2/2)^2;   %二级杆横截面积
fr3=pi*(DL3/2)^2;   %三级杆横截面积
lamda=WL/E*(L1/fr1+L2/fr2+L3/fr3); %静载冲程损失
Sp=S-lamda;    %柱塞冲程长度   
Area_LL=0.5*WL*Sp;
