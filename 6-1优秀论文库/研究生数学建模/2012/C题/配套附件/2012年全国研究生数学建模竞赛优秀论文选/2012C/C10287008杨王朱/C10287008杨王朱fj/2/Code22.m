...
TM=(ru-rul)*((pi*DR1*DR1/4)*LL1)*9.8
D=D-TM; %去重力载荷
%计算sig0,vel0
sig0=0.0;
vel0=0.0;
...
%计算二级杆
U=Ux;
TM=(ru-rul)*((pi*DR2*DR2/4)*LL2)*9.8;
D=Fx-TM; %去重力载荷
%计算sig0,vel0
sig0=0.0;
vel0=0.0;
...
%计算三级杆
U=Ux;
TM=(ru-rul)*((pi*DR3*DR3/4)*LL3)*9.8;
D=Fx-TM; %去重力载荷
%计算sig0,vel0
sig0=0.0;
vel0=0.0;
