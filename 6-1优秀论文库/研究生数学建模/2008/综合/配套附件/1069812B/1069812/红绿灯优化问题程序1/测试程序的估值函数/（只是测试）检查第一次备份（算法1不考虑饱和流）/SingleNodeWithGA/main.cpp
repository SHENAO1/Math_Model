...
int printbest(){
	...
	cout<<"best is:"<<endl<<"x1="<<items[maxIndex].x1<<endl<<"x2="<<items[maxIndex].x2-items[maxIndex].x1<<endl<<"x3="<<items[maxIndex].x3-items[maxIndex].x2<<endl<<"x4="<<items[maxIndex].x4-items[maxIndex].x3<<endl;
	cout<<"best value is: "<<1000/value<<endl;
...
int main(){
		...
		//}
		//int best=printbest();
		//int eval=(items[best].x4+3)/4;
		Individual* fixed1= new Individual(1,2,4,5);
		cout<<"fixed1: "<<fixed1->getValue();
//		Individual* fixed2=new Individual(1,2,4,5);
//		cout<<"fixed2: "<<fixed2->getValue();
		//Individual* fixed3=new Individual(1,2,3,4);
		//cout<<"fixed3: "<<fixed3->getValue();
}