function [ER,OrderList] = Optimization(DeltaL,arf,r)
...
Dis = -100;
while Dis<0
    [BRealPointList(j,:),OrderList(j-1,:),APB] = Equation(DeltaL,APB,AP0,BRealPointList(j-1,:),DeltaArf,j-1,r,arf,m);
